...
const TRESHOLD_START = 100; //setup first pixel where to start slider to change slides on scroll 

const CHANGE_IMAGE_VALUE = 200; //how many pixels we need to scroll before slide change
